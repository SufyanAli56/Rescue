        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-6">
              Real-time emergency response platform connecting people in need with nearby volunteers.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/map" className="text-gray-400 hover:text-white text-sm transition-colors">
                  Live Map
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-12 pt-8 border-t border-white/10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm">
              © {new Date().getFullYear()} RapidRescue. All rights reserved.
            </p>
