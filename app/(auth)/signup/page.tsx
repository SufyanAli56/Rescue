...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-red-900 to-slate-900 px-4 py-12">
      {/* Animated background */}
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="bg-white/10 backdrop-blur-xl rounded-2xl border border-white/20 p-8 shadow-2xl">
          <div className="mb-8">
            ...
            <p className="text-gray-300">Join the emergency response network</p>
          </div>
          ...
          <form onSubmit={handleSignup} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all"
              />
            </div>
            ...
            <div className="bg-gradient-to-r from-red-500/10 to-orange-500/10 border border-red-500/20 rounded-xl p-4">
              <div className="flex items-start gap-3">
                <input
                  ...
                  onChange={handleChange}
                  className="mt-1 w-4 h-4 rounded border-white/20 bg-white/5 text-red-600 focus:ring-red-500 focus:ring-offset-0"
                />
                <div>
                  <label htmlFor="isVolunteer" className="block text-sm font-medium text-white cursor-pointer">
                    I want to be a volunteer
                  </label>
                  <p className="text-xs text-gray-300 mt-1">
                    Help others in emergency situations by responding to alerts in your area
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="mt-6 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-yellow-500/10 border border-yellow-500/20 rounded-lg">
            ...
            <span className="text-sm text-yellow-200">Demo Mode: Registration will redirect to dashboard</span>
          </div>
        </div>
      </div>
    </div>
